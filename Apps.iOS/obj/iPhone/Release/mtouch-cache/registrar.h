...
@class Apps_iOS_Models_iOSNotificationReceiver;
...
@interface Apps_iOS_Models_iOSNotificationReceiver : NSObject<UNUserNotificationCenterDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface CurvedPicker_iOS_CustomPickerRenderer : Xamarin_Forms_Platform_iOS_PickerRenderer {
}
	-(id) init;
@end
...
@interface CurvedEntry_iOS_CustomEditorRenderer : Xamarin_Forms_Platform_iOS_EditorRenderer {
}
	-(id) init;
@end
...
@interface CurvedEntry_iOS_CustomEntryRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
